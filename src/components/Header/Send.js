...
const Send = () => {
  ...
  const submitHandler = (e) => {
    ...
    fetch(
      `https://mail-box-client-fc026-default-rtdb.firebaseio.com/sentbox/${sender1}.json`,
    ...
    fetch(
      `hhttps://mail-box-client-fc026-default-rtdb.firebaseio.com/inbox/${receiver}.json`,
